...
All environment variables should start with "PROMPTUNE_" prefix.

For example if you see in your "promptune/settings.py" a variable named like
`random_parameter`, you should provide the "PROMPTUNE_RANDOM_PARAMETER" 
variable to configure the value. This behaviour can be changed by overriding `env_prefix` property
in `promptune.settings.Settings.Config`.

An example of .env file:
```bash
PROMPTUNE_RELOAD="True"
PROMPTUNE_PORT="8000"
PROMPTUNE_ENVIRONMENT="dev"
```
